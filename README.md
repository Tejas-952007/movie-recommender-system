...
- Search any movie → get 5 similar recommendations with posters
- Browse by genre (Action, Comedy, Drama, Romance)
- TMDB poster integration (requires internet)
